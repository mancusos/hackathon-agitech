...
public class ApiClient {
    ...
    private String basePath = "https://api-visa.sensedia.com/sandbox/visa/correios/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-visa.sensedia.com/sandbox/visa/correios/v1
