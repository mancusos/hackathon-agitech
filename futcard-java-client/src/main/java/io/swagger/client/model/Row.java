...
public class Row {
  ...
  **/
  ...
  public Row seats(List<EventseventIdsectorssectorIdsubsectorssubsectorIdSeats> seats) {
    this.seats = seats;
    return this;
  }

  public Row addSeatsItem(EventseventIdsectorssectorIdsubsectorssubsectorIdSeats seatsItem) {
    if (this.seats == null) {
