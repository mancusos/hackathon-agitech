...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDoFutebolcard.Seat();
  });
  ...
  describe('Seat', function() {
    it('should create an instance of Seat', function() {
      // uncomment below and update the code to test Seat
      //var instane = new ApiDoFutebolcard.Seat();
      //expect(instance).to.be.a(ApiDoFutebolcard.Seat);
    });
