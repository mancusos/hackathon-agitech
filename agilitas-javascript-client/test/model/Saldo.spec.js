...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiAgillitasCartesPrPagos.Saldo();
  });
  ...
  describe('Saldo', function() {
    it('should create an instance of Saldo', function() {
      // uncomment below and update the code to test Saldo
      //var instane = new ApiAgillitasCartesPrPagos.Saldo();
      //expect(instance).to.be.a(ApiAgillitasCartesPrPagos.Saldo);
    });
