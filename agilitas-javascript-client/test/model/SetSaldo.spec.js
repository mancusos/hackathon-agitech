...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiAgillitasCartesPrPagos.SetSaldo();
  });
  ...
  describe('SetSaldo', function() {
    it('should create an instance of SetSaldo', function() {
      // uncomment below and update the code to test SetSaldo
      //var instane = new ApiAgillitasCartesPrPagos.SetSaldo();
      //expect(instance).to.be.a(ApiAgillitasCartesPrPagos.SetSaldo);
    });
