...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiAgillitasCartesPrPagos.Valor();
  });
  ...
  describe('Valor', function() {
    it('should create an instance of Valor', function() {
      // uncomment below and update the code to test Valor
      //var instane = new ApiAgillitasCartesPrPagos.Valor();
      //expect(instance).to.be.a(ApiAgillitasCartesPrPagos.Valor);
    });
